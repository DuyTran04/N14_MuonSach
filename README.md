...
🚀 HƯỚNG DẪN CÀI ĐẶT
Yêu Cầu
Python 3.x: Cài đặt Python trên hệ thống của bạn.
PostgreSQL: Cài đặt và cấu hình cơ sở dữ liệu PostgreSQL.
Các Bước Cài Đặt
Clone dự án:
...
Cập nhật thông tin kết nối cơ sở dữ liệu trong main.py:
